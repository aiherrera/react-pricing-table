...
const Subtitle = Ye.div``;

const Price = Ye.div`
  text-decoration: ${(props) => (props.discount ? 'line-through' : 'none')};
`;

const Discount = Ye.div``;

const Features = Ye.div`
  display: flex;
  flex-direction: column;
  ul {
    list-style: none;
...
var Pricingtable = function (_a) {
    var plans = _a.plans, color = _a.color, handleClick = _a.handleClick;
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Section, null,
            React__default['default'].createElement("h1", null, "Pricing table"),
            React__default['default'].createElement("h3", null, "Select the best plan for your next awesome website")),
        React__default['default'].createElement(Container, { color: color.popular }, plans.map(function (plan) { return (React__default['default'].createElement(Card, { color: color, key: plan.id, popular: plan.popular },
            React__default['default'].createElement(Circle, { popular: plan.popular, color: color }, plan.circle),
            React__default['default'].createElement(Header, { popular: plan.popular, color: color },
                React__default['default'].createElement(Title, null, plan.title),
                React__default['default'].createElement(Subtitle, null, plan.subtitle),
                React__default['default'].createElement(Price, { discount: plan.discount }, plan.price),
                React__default['default'].createElement(Discount, null, plan.discount)),
            React__default['default'].createElement(Button, { color: color, onClick: function () { return handleClick(plan.id); } }, plan.buttonText),
            React__default['default'].createElement(Features, { color: color }, plan.features))); }))));
};
